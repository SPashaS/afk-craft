...
export let formValidate = {
	...
	addError(formRequiredItem) {
		...
		formRequiredItem.closest('.form-order__row').classList.add('_form-error');
...
export function formQuantity() {
	...
	// 	let targetElement = e.target;
	// 	if (targetElement.closest('.quantity__button')) {
	// 		let quantityElement = targetElement.closest('.quantity');
	// 		let input = quantityElement.querySelector('input');
	// 		let minusButton = quantityElement.querySelector('.quantity__button_minus');
	...
	document.addEventListener("click", function (e) {
		...
		if (targetElement.closest('.quantity__button')) {
			...
			let input = quantityElement.querySelector('input');
			let minusButton = quantityElement.querySelector('.quantity__button_minus');
			let plusButton = quantityElement.querySelector('.quantity__button_plus');
			
			// Извлекаем максимальное количество из data-quantity-max
			let maxQuantity = parseInt(quantityElement.getAttribute('data-quantity-max'));
